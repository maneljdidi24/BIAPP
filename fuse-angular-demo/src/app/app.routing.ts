...
import { DisplayComponent } from './modules/admin/apps/extraction/display/display.component';
...
export const appRoutes: Route[] = [
    ...
    {path: 'signed-in-redirectSus', pathMatch : 'full', redirectTo: 'sustainability/main'}, 
    ...
    },
    {
        ...
        children   : [
            // Dashboards
            {path: 'HR', children: [
                {path: 'employee', loadChildren: () => import('app/modules/admin/apps/rh/rh.module').then(m => m.RhModule)},
...

    {
        ...
        children   : [
            ...
            {path: 'dashboards', children: [
                ...
                {path: 'project', loadChildren: () => import('app/modules/admin/apps/extraction/extraction.module').then(m => m.ExtractionModule)},
                {path: 'analytics', loadChildren: () => import('app/modules/admin/dashboards/analytics/analytics.module').then(m => m.AnalyticsModule)},
            ]},
            {path: 'sustainability', loadChildren: () => import('app/modules/admin/apps/sustainability/sustainability.module').then(m => m.SustainabilityModule)},
            ...
            //    {path: 'notes', loadChildren: () => import('app/modules/admin/apps/notes/notes.module').then(m => m.NotesModule)},
                  {path: 'tasks', loadChildren: () => import('app/modules/admin/apps/etl/etl.module').then(m => m.ETLModule)},
            ]},
...
/*                 {path: 'pricing', children: [
               ...
               // {path: 'profile', loadChildren: () => import('app/modules/admin/pages/profile/profile.module').then(m => m.ProfileModule)},
                ...
                // Settings
                {path: 'settings', loadChildren: () => import('app/modules/admin/apps/user-management/user-management.module').then(m => m.UserManagementModule)},
           
                //{path: 'settings1', loadChildren: () => import('app/modules/admin/pages/settings/settings.module').then(m => m.SettingsModule)},
            ]},
          ...
          /*   {path: 'sustainability', children: [
                {path: 'performance', loadChildren: () => import('app/modules/admin/apps/sustainability/sustainability.module').then(m => m.SustainabilityModule)},
